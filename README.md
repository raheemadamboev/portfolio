...
| **34** | **Currency Converter** | This app helps users to convert currency from one to another online. | MVVM, Hilt Dependency Injection, Kotlin Coroutines, Retrofit, ViewBinding, StateFlow, Material Design, Git... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/currency-converter-app) |
| **35** | **Random Footballer** | Basic app to get random footballer data from KTOR backend server that I built and show it. | Jetpack Compose, Clean Architecture, MVVM, Hilt Dependency Injection, Kotlin Coroutines, Git, Flow, State, Coil, Retrofit... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/random-footballer) |
| **36** | **Push Notification KTOR One Signal** | Basic app to send data to KTOR backend server that I built and that data eventually get sent to all users that the app is installed. | Jetpack Compose, Clean Architecture, MVVM, Hilt Dependency Injection, Kotlin Coroutines, KTOR Client, Git, One Signal, Kotlin Serialization, Flow, State... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/push-notification-ktor-one-signal) |
| **37** | **Meditation UI** | Beautiful meditation app. | Jetpack Compose, LazyVerticalGrid, Canvas... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/meditation-ui) |
| **38** | **Instagram Profile UI** | Clone of the UI of the Instagram profile section. | Jetpack Compose, LazyVerticalGrid... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/instagram-profile-ui) |
| **39** | **Jetpack Compose Live Connection** | Basic app to check internet connection in live time. It can respond to connection changes automatically and checks actual internet connection by trying to connect Google DNS servers and it informs users lively. | Jetpack Compose, LiveData... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/jetpack-compose-live-connection-app) |
| **40** | **Posts KTOR Client** | Basic app to get data from the server and show them in the list. | Jetpack Compose, Clean Architecture, MVVM, Hilt Dependency Injection, Kotlin Coroutines, Git, KTOR Client, Kotlin Serialization, Flow, State... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/posts-ktor-client) |
| **41** | **StateFlow, Flow, SharedFlow, LiveData** | Basic app to use different types of observables StateFlow, Flow, SharedFlow, LiveData, State, Channel... | Hilt Dependency Injection, Kotlin Coroutines, Flow, StateFlow, SharedFlow, LiveData, ViewModel... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/stateflow-flow-sharedflow-livedata) |
| **42** | **Jetpack Compose ToDo API** | A basic app that gets data from servers and shows them in the list. | Jetpack Compose, MVVM, Hilt Dependency Injection, Kotlin Coroutines, Retrofit, State... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/jetpack-compose-todo-api-app) |
| **43** | **Room Relations** | This app is to use Room Entity relationship models. In this project ONE-TO-ONE, ONE-TO-N and N-TO-M relationship models are used. Room makes it really concise and easy to work with SQLite tables in android. U can join tables easily with room. | Kotlin Coroutines, Room, ViewBinding... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/room-relations-app) |
| **44** | **Jetpack DataStore Preferences** | Simple app to save values in Jetpack Data Store Preferences. | Jetpack DataStore Preferences, Kotlin Coroutines, ViewBinding, Flow... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/datastore-preferences-app) |
| **45** | **Channel** | Simple app to use Kotlin Channel. | Kotlin Coroutines, ViewModel, Channel, Flow, ViewBinding... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/channel-app) |
| **46** | **Dagger Hilt** | Plain app to use Dagger Hilt Dependency Injection. | Hilt Dependency Injection, ViewModel... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/dagger-hilt-app) |
| **47** | **StateFlow** | Simple app to use Kotlin StateFlow. | Kotlin Coroutines, StateFlow, ViewBinding, ViewModel... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/state-flow-app) |
| **48** | **Flow** | Simple app to use Kotlin Flow. | Kotlin Coroutines, Flow, ViewBinding... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/flow-app) |
| **49** | **FAB Explosion Animation** | Simple app with floating action button that animates explosion to open new fragment or activity. | ViewBinding, Animation... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/fab-explosion-animation-app) |
| **50** | **Rocket Animation** | A basic app that makes animates the rocket to fly. | Jetpack Compose, Animation... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/jetpack-compose-rocket-animation-app) |
| **51** | **Animated Progress Bar** | Aesthetic animated progress bar. | Jetpack Compose, Kotlin Coroutines, Canvas, Animation... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/animated-progress-bar) |
| **52** | **3D Animated Dropdown Menu** | Aesthetic 3D animated dropdown menu. | Jetpack Compose, Kotlin Coroutines, Animation... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/3D-animated-dropdown-menu) |
| **53** | **Jetpack Compose Navigation** | Basic app to implement Jetpack Compose Navigation. | Jetpack Compose, Jetpack Compose Navigation... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/jetpack-compose-navigation) |
| **54** | **Media Query Size** | Basic app to implement media query for Jetpack Compose to support all screen sizes. | Jetpack Compose, Media Query... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/media-query-size) |
| **55** | **Music Knob** | Music knob component. | Jetpack Compose, Canvas... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/music-knob) |
| **56** | **Timer Component** | Beautiful timer component. | Jetpack Compose, Canvas... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/timer-component) |
| **57** | **Bottom Navigation Badges** | Stylish bottom navigation component with badges. | Jetpack Compose, Bottom Navigation Bar with Badges... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/bottom-navigation-badges) |
| **58** | **Animated Splash Screen** | Aesthetically pleasing and animated splash screen. | Jetpack Compose, Animated Splash Screen... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/animated-splash-screen) |
| **59** | **Multi-Select LazyColumn** | Basic use case of multi-selecting items in LazyColumn. | Jetpack Compose, LazyColumn... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/multi-select-lazy-column) |
| **60** | **Multi-Layer Parallax Scroll Effect** | Pleasing use case of multi-layer parallax scroll effect. | Jetpack Compose, LazyColumn... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/multi-layer-parallax-scroll-effect) |
| **61** | **Canvas Basics** | Jetpack Compose basic actions with Canvas... | Jetpack Compose, Canvas... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/canvas-basics) |
| **62** | **Jetpack Compose Playground** | Jetpack Compose basics. | Jetpack Compose... | [![pic](https://img.shields.io/badge/GitHub-35006a?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raheemadamboev/jetpack-compose-playground-app) |
